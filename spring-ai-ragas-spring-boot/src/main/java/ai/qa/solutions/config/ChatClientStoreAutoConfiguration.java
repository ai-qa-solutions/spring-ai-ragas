...
@ConditionalOnProperty(
        ...
        havingValue = "true",
        matchIfMissing = true)
@EnableConfigurationProperties(ChatClientStoreAutoConfiguration.ChatModelProperties.class)
public class ChatClientStoreAutoConfiguration {
     ...
     * @param simpleLoggerAdvisor optional logging advisor (null if logging is disabled)
    ...
    public ChatClientStore chatClientStore(
        ...
        final ChatClient.Builder defaultBuilder = simpleLoggerAdvisor != null
                ...
                : chatClientBuilder;
        final ChatClient defaultClient = defaultBuilder.build();
