...
//                "score5_description",
//                        "The response is completely accurate, clear, and thoroughly addresses the reference without
// any errors.");
//
...
//                .response(
//                        "The Earth is round due to gravity pulling matter toward the center, forming a sphere. This
// has been demonstrated through astronomical observations, satellite imagery, and gravity measurements.")
//                .reference(
//                        "The Earth is round because of gravitational forces and has been proven through various
// scientific methods.")
//                .build();
//    }
//
...
//                .thenReturn(
//                        "{\"score\": 5, \"rubric_level\": \"score5_description\", \"reasoning\": \"Excellent
...
//        when(llmService.evaluate(anyString()))
//                .thenReturn(
//                        "{\"score\": 3, \"rubric_level\": \"score3_description\", \"reasoning\": \"Good but lacks some
// detail\"}");
