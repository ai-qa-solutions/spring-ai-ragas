...
public class FaithfulnessMetric {
    ...
    @NonNull
    @Builder.Default
    private final String statementGeneratorTemplate = DEFAULT_STATEMENT_GENERATOR_TEMPLATE;

    @NonNull
    @Builder.Default
    private final String nliStatementTemplate = DEFAULT_NLI_STATEMENT_TEMPLATE;
